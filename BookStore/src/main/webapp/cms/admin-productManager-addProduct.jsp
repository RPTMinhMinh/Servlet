...
<head>
  ...
  <title>${username}: Thêm sản phẩm</title>
  ...
  <section class="section-content">
    <div class="container">
      ...
      <main class="add-book-form mb-5">
        <form class="w-50" action="insert-product" method="post">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="add-book-yearPublishing" name="yearPublisher">
          </div>
          <div class="mb-3">
