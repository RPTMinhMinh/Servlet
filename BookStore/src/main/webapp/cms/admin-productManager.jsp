  ...
  <section class="section-content">
    <div class="container">
      <header class="section-heading py-4 d-flex justify-content-between">
        ...
        <a class="btn btn-primary" href="form_insert" role="button" style="height: fit-content;">Thêm sản phẩm</a>
          ...
          <c:forEach var="product" items="${products}">
            <tr>
              ...
              <td class="text-center text-nowrap">
                ...
                <a class="btn btn-success me-2" href="form-update?id=${product.id}" role="button">Sửa</a>
                <a class="btn btn-danger" href="delete-product?id=${product.id}" role="button">Xóa</a>
              </td>
            </tr>
          </c:forEach>
          </tbody>
