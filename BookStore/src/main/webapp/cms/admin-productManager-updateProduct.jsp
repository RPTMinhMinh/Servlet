...
<section class="section-content">
    <div class="container">
        ...
        <main class="add-book-form mb-5">
            <form class="w-50" action="update-product" method="post">
                <input type="hidden" name="id" value="${product.id}">
                <div class="mb-3">
                    <label for="add-book-title" class="form-label">Tên sách</label>
                    <input type="text" value="${product.name}" class="form-control" id="add-book-title" name="name">
                </div>
                <div class="mb-3">
                    <label for="add-book-author" class="form-label">Tác giả</label>
                    <input type="text" value="${product.author}" class="form-control" id="add-book-author" name="author">
                </div>
                <div class="mb-3">
                    <label for="add-book-pages" class="form-label">Số trang</label>
                    <input type="number" value="${product.pages}" class="form-control" id="add-book-pages" name="pages">
                </div>
                <div class="mb-3">
                    <label for="add-book-publisher" class="form-label">Nhà xuất bản</label>
                    <input type="text" value="${product.publisher}" class="form-control" id="add-book-publisher" name="publisher">
                </div>
                <div class="mb-3">
                    <label for="add-book-yearPublishing" class="form-label">Năm phát hành</label>
                    <input type="number" value="${product.yearPublishing}" class="form-control" id="add-book-yearPublishing" name="yearPublisher">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" value="${product.price}" class="form-control" id="add-book-price" name="price">
                </div>
                <div class="mb-3">
                    <label for="add-book-discount" class="form-label">Khuyến mãi</label>
                    <input type="number" value="${product.discount}" class="form-control" id="add-book-discount" name="discount">
                </div>
                <div class="mb-3">
                    <label for="add-book-quantity" class="form-label">Số lượng trong kho</label>
                    <input type="number" value="${product.quantity}" class="form-control" id="add-book-quantity" name="quantity">
                </div>
                <div class="mb-3">
                    <label for="add-book-description" class="form-label">Mô tả</label>
                    <textarea class="form-control" value="${product.description}" id="add-book-description" rows="5" name="description"></textarea>
                </div>
                <div class="mb-3">
                    <label for="add-book-imageName" class="form-label">Hình</label>
                    <input type="file" value="${product.image}" class="form-control" id="add-book-imageName" name="image">
                </div>
