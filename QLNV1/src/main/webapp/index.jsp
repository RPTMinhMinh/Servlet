...
<div class="row g-3">
    ...
    <div class="col-sm-9">
        <div>
            ...
            <form action="form_insert" method="get">
                ...
                <c:forEach var="employeeModel" items="${employees}">
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <div class="col">
                                    <a href="delete_employee?id=${employeeModel.id}" class="btn btn-outline-danger">Delete</a>                                </div>
                                <div class="col">
                                    <a href="form_update?id=${employeeModel.id}" class="btn btn-outline-warning">Edit</a>
                                </div>
                            </div>
                        </td>
                    </tr>
